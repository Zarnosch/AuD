...
/** Base class for a binary search tree.<p>
    ...
    data that is stored or extra indirections for method calls.</li>
    ...
    <h3>Nodes store key-value pairs</h3>

    Each {@link aud.BinarySearchTree.Node} stores a <em>key-value</em>
    pair of type {@link aud.BinarySearchTree.Entry} as node data.

    {@BinarySearchTree} is a
    <a href="http://docs.oracle.com/javase/tutorial/java/generics/types.html">generic class</a>,
    and </em>{@code Key} and {@code Value} are provided as
    ...
    Tamassia</em> (2nd ed, chapter 7.4, p. 269).<br>
    ...
    The method {@link #restructure(char,Object)} is provided for testing
    ...
    <h3>Notifications on insert/remove</h3>
...
public class BinarySearchTree<Key extends Comparable<Key>,Value>
  ...
  */
  ...
  /** Restructure subtree following <b>Goodrich&Tamassia</b> (2nd ed, p. 269).<p>
  ...
  /** Setup balanced subtree.<p>
      ...
      Follows Goodrich&Tamassia (2nd ed, p. 269).<p>
      See also lecture slides for names of symbols.
  ...
  /** Interactive restructuring for testing.<p>
      @param action one of {@code '<', '>', '='} corresponding to application of
      {@link #rotateLeft}, {@link #rotateRight}, and {@link #restructure(Node)},
      respectively.
