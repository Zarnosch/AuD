...
/** Undirected graph that is defined implicitly by a regular 2d
    ...
    codes</a> will be displayed correctly only on a "command window"
    with a terminal emulation like typically provided by any <b>Unix
    terminals</b>. (It will <em>not</em> work with the standard
    Windows command prompt {@code cmd.exe}!)
 */
public class Grid {
