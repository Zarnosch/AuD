 ...
 * algorithm, it us usually better to store the map {@link #position_} as an
 * {@code int} attribute of nodes in the graph (efficient and direct access).
 * This, however, requires that the implementation of the graph data structure
 * and the priority queue are closely coupled.
 */
